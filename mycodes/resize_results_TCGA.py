...
path0='/home/azamhamidinekoo/Documents/projects/Azam_HDGAN_feb21/results/TCGA/'
extention = 'he_erg_1024p_1feb21/test_latest/images'
cws_dir = '/home/azamhamidinekoo/Documents/projects/Azam_HDGAN_feb21/dataset/TCGA/'
        ...
        for subdir, dirs, files in os.walk(path1):
            ...
            for f in files:
                if f.find('_synthesized_image')!= -1:
                    ...
                    cws = Image.open(os.path.join(cws_dir,js,'test_A',fname))
                    a,b = cws.size
