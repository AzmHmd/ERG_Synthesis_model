...
path0='/home/azamhamidinekoo/Documents/projects/Azam_HDGAN_feb21/results/SIMON/'
extention = 'he_erg_1may21/test_corrected'
cws_dir = '/home/azamhamidinekoo/Dropbox (ICR)/simon_brain/data_cws/'
where_to_save = '/home/azamhamidinekoo/Dropbox (ICR)/simon_brain/results_1/'
    ...
    if js.find('ndpi') != -1:
        ...
        for subdir, dirs, files in os.walk(path1):
            ...
            for f in files:
                ...
                cws = Image.open(os.path.join(cws_dir,js,f))
                a,b = cws.size
